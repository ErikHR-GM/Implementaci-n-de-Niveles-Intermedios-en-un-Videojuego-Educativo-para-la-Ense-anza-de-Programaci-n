function cargar_pregunta() {
    ...
    var p = obj_control.preguntas[obj_control.indice_pregunta];
    ...
    obj_r1.texto_respuesta = respuestas[0];
    obj_r2.texto_respuesta = respuestas[1];
    obj_r3.texto_respuesta = respuestas[2];
    obj_r4.texto_respuesta = respuestas[3];

    // Guardar la respuesta correcta original
    obj_control.respuesta_correcta = p[1];
}
