...
if (global.puntaje >= global.puntos_victoria) {
    ...
    global.tiempo_jugado = 125 - ceil(global.tiempo_nivel / room_speed); // 90 segundos menos el tiempo restante
    ...
    scr_desbloquear_nivel("python", 3);
    ...
    var linea = fecha + " " + hora + " - Completó nivel 3 de Python en " + string(global.tiempo_jugado) + " segundos\n";
...
if (global.tiempo_nivel > 0) {
    ...
    if (global.tiempo_nivel <= 0) {
        ...
        global.tiempo_jugado = 125; // El jugador agotó todo el tiempo
